...
export const AdventureSidebar = ({ 
  ...
  if (!isOpen) {
    return (
      <div className="w-12 border-r bg-background flex flex-col h-[calc(100vh-3.5rem)]">
        <div className="p-2">
          <Button 
            variant="ghost" 
            size="icon"
  ...
  return (
    <div className="w-80 border-r bg-background flex flex-col h-[calc(100vh-3.5rem)]">
